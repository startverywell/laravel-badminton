...
class ThemeCustomizer {
    ...
    initSwitchListener() {
        ...
        // leftside-search
        var searchToggleBtn = document.querySelector('.button-toggle-search');
        if (searchToggleBtn) {
            searchToggleBtn.addEventListener('click', function () {
                ...
                // Todo: old implementation
                self.html.classList.toggle('sidebar-search-enable');

            });
        }

        var searchCloseBtn = document.querySelector('.button-search-close-fullsidebar');
        if (searchCloseBtn) {
            searchCloseBtn.addEventListener('click', function () {
                self.html.classList.remove('sidebar-search-enable');
                self.hideBackdrop();
            });
        }

        // leftside-user
        var userToggleBtn = document.querySelector('.button-toggle-user');
        if (userToggleBtn) {
            userToggleBtn.addEventListener('click', function () {
                ...
                // Todo: old implementation
                self.html.classList.toggle('sidebar-user-enable');

            });
        }

        var userCloseBtn = document.querySelector('.button-user-close-fullsidebar');
        if (userCloseBtn) {
            userCloseBtn.addEventListener('click', function () {
                self.html.classList.remove('sidebar-user-enable');
                self.hideBackdrop();
            });
        }
